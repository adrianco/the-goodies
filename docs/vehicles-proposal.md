...
Three vehicles from the actual collection, as the system would hold them. Dates, mileage and money are real fields; the text is what a walk transcribed. Each one stresses a different part of the design.
...
4. **Identity.** What is *the* number for a car in your world — VIN, chassis number, registration, something else? For bikes? For race cars that have been re-shelled?
